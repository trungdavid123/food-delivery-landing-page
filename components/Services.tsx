...
interface Iprops {
    title: String,
    desc: String,
    card_title_1: String, card_title_2: String, card_desc_1: String, card_desc_2: String
}

const Services: React.FC<Iprops> = ({title, desc, card_desc_1, card_desc_2, card_title_1,card_title_2}) => {
    return (
            ...
            <div className='py-10'>
                ...
                <div className='px-5 gap-5 lg:px-20 grid md:grid-cols-2 grid-cols-1 lg:grid-cols-2 md:10 lg:gap-16 mt-10'>
                    <div className='shadow h-[35vh] flex flex-col gap-2 px-5 py-5 bg-white rounded-lg'>
                        ...
                        <h3 className='text-xl text-[#552828] font-bold'>{card_title_1}</h3>
                        <p className='text-sm text-[#545252]'>{card_desc_1}</p>
                    </div>
                    ...
                    <div className='shadow h-[35vh] flex flex-col gap-2 px-5 py-5 bg-white rounded-lg'>
                        ...
                        <h3 className='text-xl text-[#552828] font-bold'>{card_title_2}</h3>
                        <p className='text-sm text-[#545252]'>{card_desc_2}</p>
                    </div>
